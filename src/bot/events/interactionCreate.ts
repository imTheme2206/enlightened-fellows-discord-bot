  ...
  if (interaction.isButton()) {
    ...
    if (handler) {
      try {
        ...
        logger.error(`Error handling button for command ${commandName}:`, { error })
      }
    }
    return
  }
  ...
  if (interaction.isStringSelectMenu()) {
    ...
    if (command?.handleComponent) {
      try {
        ...
        logger.error(`Error handling select menu for command ${commandName}:`, { error })
      }
    }
    return
  }
  ...
  if (interaction.isModalSubmit()) {
    ...
    if (command?.handleModal) {
      try {
        ...
        logger.error(`Error handling modal for command ${commandName}:`, { error })
      }
    }
    return
  }
