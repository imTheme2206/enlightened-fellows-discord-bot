 ...
 */
export const buildSearchResultEmbed = (result: SearchResult, index: number, total: number): EmbedBuilder => {
  const embed = new EmbedBuilder().setTitle(`Set ${index} of ${total}`).setColor(0x2b82d7)
